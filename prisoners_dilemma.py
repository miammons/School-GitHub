...
#Modify this list to change which strategies are included in the game.
#You can include multiples of a strategy if you wish.
modules_for_game = [team2, team2, team2, team2, example1, example3, example4, example5, example5]
...
if __name__ == '__main__':
    scores, moves, reports = main_play(modules_for_game)   
    section0, section1, section2, section3 = reports